...
layout = dbc.Card(
    [
        html.H1("Organizador Financeiro", className="text-primary"),
        html.P("By Thiago", className="text-secondary"),
        html.Hr(),
        # Seção PERFIL ------------------------
        dbc.Button(
            id="botao_avatar",
...
def salve_form_receita(n, descricao, valor, date, switches, categoria, dict_receitas):
    ...
    if n and not (valor == "" or valor is None):
        ...
        categoria = categoria[0] if isinstance(categoria, list) else categoria
